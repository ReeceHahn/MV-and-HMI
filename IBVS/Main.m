...
while ~complete
    ...
    %------ Your code here -----------------------------------------
    current_position = T_s_e_current(1:3, 4);
    %---------------------------------------------------------------
    % Calculate the distance between current and target position X_target
    % Construct a stopping condition for the while loop with this error (hint: using error_max)
    % Otherwise THIS LOOP will run FOREVER!!!!
    %------ Your code here -----------------------------------------
    displacement_vector = current_position - X_target;
